# Solana SPL Token Chrome Extension Wallet

## Features

This is a Solana SPL Token Chrome Extension Wallet.
...
To this task the project import the file `./secrets.<THE-NODE_ENV>.js` on your modules through the module named as `secrets`, so you can do things like this:
